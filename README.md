...
5. **MainScreen** - основной экран с нижней навигационной панелью
6. **CarListScreen** - список доступных автомобилей
7. **CarDetailScreen** - детальная информация об автомобиле и бронирование
8. **BookingListScreen** - список бронирований пользователя
